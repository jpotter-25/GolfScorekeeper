...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-game-green via-game-felt to-emerald-900 flex flex-col items-center justify-center px-6 relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-white bg-opacity-5 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-white bg-opacity-5 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-white bg-opacity-3 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <div className="text-center mb-16">
          <div className="mb-8">
            ...
            <p className="text-2xl md:text-3xl text-game-cream font-light mb-4 drop-shadow-lg">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-3xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-game-cream text-sm opacity-80">Unlock achievements and collect coins</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-game-cream text-sm opacity-80">Monitor stats and level up your skills</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-game-cream text-sm opacity-80">Personalize cards and themes</p>
            </div>
          </div>
        </div>
          ...
          <Card className="bg-white bg-opacity-10 backdrop-blur-lg border-white border-opacity-20 shadow-2xl">
            <CardContent className="p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-game-cream opacity-90">Sign in with your Replit account to get started</p>
              </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-white opacity-70 text-sm mb-3">What you'll get:</p>
                <div className="space-y-2 text-left">
                  <div className="flex items-center space-x-3 text-game-cream text-sm">
